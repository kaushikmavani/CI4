...
<head>
  ...
  <!-- pace-progress -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/public/plugins/pace-progress/themes/black/pace-theme-flat-top.css">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url('changePassword') ?>" class="nav-link">Change Password</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-info elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <img src="<?php echo (\Config\Services::session()->get('profile') != '') ? (file_exists(FCPATH."public\images\userProfile\\".\Config\Services::session()->get('profile'))) ? base_url()."/public/images/userProfile/".\Config\Services::session()->get('profile') : base_url()."/public/dist/img/default.png" : base_url()."/public/dist/img/default.png" ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="<?php echo base_url('profile') ?>" class="d-block"><?= ucwords(\Config\Services::session()->get('firstname')).' '.ucwords(\Config\Services::session()->get('lastname')) ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php 
            ...
            $gallary = '';
            $language = '';
            switch (\Config\Services::router()->controllerName().'\\'.\Config\Services::router()->methodName())
            {
              case '\App\Controllers\DashboardController\index':
                $dashboard = 'active';
                break;
              case '\App\Controllers\UserController\index':
                $users = 'active';
                break;
              case '\App\Controllers\UserController\create':
                $users = 'active';
                break;
              case '\App\Controllers\UserController\edit':
                $users = 'active';
                break;
              case '\App\Controllers\UserController\permission':
                $users = 'active';
                break;
              case '\App\Controllers\RoleController\index':
                $roles = 'active';
                break;
              case '\App\Controllers\RoleController\create':
                $roles = 'active';
                break;
              case '\App\Controllers\RoleController\edit':
                $roles = 'active';
                break;
              case '\App\Controllers\ModuleController\index':
                $modules = 'active';
                break;
              case '\App\Controllers\ModuleController\create':
                $modules = 'active';
                break;
              case '\App\Controllers\ModuleController\edit':
                $modules = 'active';
                break;
              case '\App\Controllers\GallaryController\index':
                $gallary = 'active';
                break;
              case '\App\Controllers\GallaryController\upload':
                $gallary = 'active';
                break;
              case '\App\Controllers\DashboardController\language':
                $language = 'active';
                break;
          ...
          <?php if((new App\Libraries\CheckPermission)->check('users_index')) { ?>
          <li class="nav-item">
            <a href="<?= base_url('user') ?>" class="nav-link <?= $users ?>">
          ...
          <?php } ?>
          <?php if((new App\Libraries\CheckPermission)->check('roles_index')) { ?>
          <li class="nav-item">
            <a href="<?= base_url('role') ?>" class="nav-link <?= $roles ?>">
          ...
          <?php } ?>
          <?php if((new App\Libraries\CheckPermission)->check('modules_index')) { ?>
          <li class="nav-item">
            <a href="<?= base_url('module') ?>" class="nav-link <?= $modules ?>">
          ...
          <?php } ?>
          <li class="nav-item">
            <a href="<?= base_url('gallary') ?>" class="nav-link <?= $gallary ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('language') ?>" class="nav-link <?= $language ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('chat') ?>" class="nav-link <?= $language ?>">
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  <!-- pace-progress -->
<script src="<?php echo base_url(); ?>/public/plugins/pace-progress/pace.min.js"></script>
<script type="text/javascript">
  ...
  // For set message in toastr
  <?php if(\Config\Services::session()->getFlashdata('success')) { ?>
    toastr.success('<?= \Config\Services::session()->getFlashdata('success') ?>');
  <?php } ?>
  <?php if(\Config\Services::session()->getFlashdata('error')) { ?>
    toastr.error('<?= \Config\Services::session()->getFlashdata('error') ?>');
  <?php } ?>
